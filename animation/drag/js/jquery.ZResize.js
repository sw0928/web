    ...
    ZResize.prototype = {
        ...
        initResizeBox: function() {
            ...
            $('.' + self.options.itemClass).each(function() {
                ...
                var drag = 'resize-panel';
                var resizePanel = $('<strong class"'+ drag +'"></strong>');
                resizePanel.css({
        ...
        triggerResize: function(el) {
            var self = this;
            //console.log(el);
            // el.find('.w').parent().remove()
            el.siblings('.' + self.options.itemClass).children('strong').css({
                display: 'none'
            });
            el.children('strong').css({
                display: 'block'
            });
        ...
        bindHidePanel: function(el) {
            ...
            $(stage).bind('click', function() {     
                //console.log($('.bb').find('.w'));
                         
                $('.active').find('strong').css({
                    display: 'none'
                });
            })
        }
